...
RSpec.describe Terminus::Aspects::Transit::Providers::Trenord::Provider do
  subject :provider do
  ...
  let(:client) { instance_double Terminus::Aspects::Transit::Providers::Trenord::Client }
  let(:registry) { instance_double Terminus::Aspects::Transit::Providers::Trenord::Registry }
