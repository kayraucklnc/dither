...
RSpec.describe Dither::Aspects::Extensions::Generators::Transit do
  subject(:generator) { described_class.new finder: }

  include Dry::Monads[:result]

  let(:finder) { instance_double Dither::Aspects::Transit::Finder }

  let :board do
    Dither::Aspects::Transit::Board[
      ...
      queried_at: "22:30",
      departures: [
        Dither::Aspects::Transit::Departure[
          line: "S5",
          number: "11881",
