...
RSpec.describe Dither::Aspects::Extensions::Fetcher::Client do
  ...
  describe "#call" do
    let :input do
      Dither::Aspects::Extensions::Fetcher::Request[
    ...
    context "with JSON" do
      ...
      it "answers success" do
        expect(client.call(input)).to be_success(
          Dither::Aspects::Extensions::Fetcher::Response[
            data: [
              {
                "title" => "Castle in the Sky",
                "director" => "Hayao Miyazaki"
    ...
    context "with image" do
      ...
      it "answers success" do
        ...
        expect(result).to be_success(Dither::Aspects::Extensions::Fetcher::Response.new)
      end
    end
    ...
    context "with POST but without body" do
      ...
      it "answers success" do
        expect(client.call(input)).to be_success(
          Dither::Aspects::Extensions::Fetcher::Response[data: "{}"]
        )
      end
    end
