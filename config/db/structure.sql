...
CREATE TABLE public.firmware (
    ...
    kind text DEFAULT 'dither'::text CONSTRAINT firmwares_kind_not_null NOT NULL,
...
CREATE TABLE public.model (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    kind text DEFAULT 'dither'::text NOT NULL,
...
CREATE TABLE public.palette (
    ...
    name text NOT NULL,
    label text NOT NULL,
    kind public.palette_kind DEFAULT 'dither'::public.palette_kind NOT NULL,
...
CREATE TABLE public.rule (
    ...
    condition_kind text DEFAULT 'always'::text NOT NULL,
    settings jsonb DEFAULT '{}'::jsonb NOT NULL,
...
CREATE TABLE public.scene (
    ...
    name text NOT NULL,
    label text NOT NULL,
    layout text DEFAULT 'full'::text NOT NULL,
    model_id integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
ALTER TABLE public.scene ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.scene_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scene_slot; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.scene_slot (
    id integer NOT NULL,
    scene_id integer NOT NULL,
...
--
-- Name: scene_slot_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.scene_slot ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.scene_slot_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scene_slot scene_slot_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scene_slot
    ADD CONSTRAINT scene_slot_pkey PRIMARY KEY (id);
...
--
-- Name: rule_device_id_position_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX rule_device_id_position_index ON public.rule USING btree (device_id, "position");


--
-- Name: scene_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX scene_name_index ON public.scene USING btree (name);


--
-- Name: scene_slot_scene_id_slot_key_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX scene_slot_scene_id_slot_key_index ON public.scene_slot USING btree (scene_id, slot_key);
...
--
-- Name: rule rule_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rule
    ADD CONSTRAINT rule_device_id_fkey FOREIGN KEY (device_id) REFERENCES public.device(id) ON DELETE CASCADE;


--
-- Name: rule rule_scene_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rule
    ADD CONSTRAINT rule_scene_id_fkey FOREIGN KEY (scene_id) REFERENCES public.scene(id) ON DELETE CASCADE;


--
-- Name: scene scene_model_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scene
    ADD CONSTRAINT scene_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.model(id) ON DELETE SET NULL;


--
-- Name: scene_slot scene_slot_extension_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scene_slot
    ADD CONSTRAINT scene_slot_extension_id_fkey FOREIGN KEY (extension_id) REFERENCES public.extension(id) ON DELETE CASCADE;


--
-- Name: scene_slot scene_slot_scene_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scene_slot
    ADD CONSTRAINT scene_slot_scene_id_fkey FOREIGN KEY (scene_id) REFERENCES public.scene(id) ON DELETE CASCADE;
